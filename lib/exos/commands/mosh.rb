module Exos
  module Commands
    class Mosh < SSH
      ...
      command :mosh do |c|
        c.syntax = "exos mosh [-i instance_id] [-n instance_name] [-r instance_role] [-u user] [-c conn_str] [username@instance_name|instance_id]"
        ...
        c.action do |args, options|
          options.default role: "ssh", conn: "mosh"
